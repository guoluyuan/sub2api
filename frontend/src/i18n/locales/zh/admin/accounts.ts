    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          agentIdentityAuth: 'Session JSON 转 Agent Identity',
          agentIdentityDesc: '使用 ChatGPT Session JSON 注册 Codex Agent Identity 并创建账号。',
          agentIdentityInputLabel: 'ChatGPT Session JSON',
          agentIdentityPlaceholder: '粘贴包含 accessToken 的 Session JSON',
          agentIdentityHint: 'accessToken 仅用于当次注册，不保存到账号凭据。',
          agentIdentityInvalid: '请输入包含 accessToken 的 Session JSON。',
          agentIdentityRegistering: '正在注册...',
          agentIdentityRegisterAndCreate: '注册并创建账号',
