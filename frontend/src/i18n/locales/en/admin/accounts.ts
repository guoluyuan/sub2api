    ...
    accounts: {
      ...
      oauth: {
        ...
        openai: {
          ...
          agentIdentityAuth: 'Session JSON to Agent Identity',
          agentIdentityDesc: 'Register a Codex Agent Identity from ChatGPT Session JSON and create the account.',
          agentIdentityInputLabel: 'ChatGPT Session JSON',
          agentIdentityPlaceholder: 'Paste Session JSON containing accessToken',
          agentIdentityHint: 'The accessToken is used only for registration and is not stored in account credentials.',
          agentIdentityInvalid: 'Enter Session JSON containing accessToken.',
          agentIdentityRegistering: 'Registering...',
          agentIdentityRegisterAndCreate: 'Register & Create Account',
